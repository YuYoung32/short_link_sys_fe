...
export const useServerStore = defineStore('server', {
    ...
    getters: {
        mbToGb: (state) => {
            return {
                memTotalSize: (state.memTotalSize / 1024 / 1024).toFixed(2),
                diskTotalSize: (state.diskTotalSize / 1024 / 1024).toFixed(2)
            };
        }
    },
    actions: {
        fetchServerStaticInfo() {
